...
const EducationPage: React.FC = () => {
  ...
  const mockEducationContent: EducationalContent = {
    courses: [
      {
        id: '1',
        title: 'Sustainable Soil Management',
        description: 'Learn advanced techniques for maintaining soil health and fertility while maximizing crop yields.',
        category: 'soil-health',
        duration: '4 weeks',
        level: 'Intermediate',
        rating: 4.8,
        students: 1240,
        thumbnail: 'https://images.unsplash.com/photo-1597571145100-34a4ec6dc44d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
        lessons: 12,
        tags: ['soil', 'sustainability'],
        instructor: 'Dr. Jane Smith',
        prerequisites: ['Basic Soil Science'],
        outcomes: ['Improve soil fertility', 'Reduce erosion', 'Enhance water retention']
      },
      {
        id: '2',
        title: 'Integrated Pest Management',
        description: 'Comprehensive guide to controlling pests using biological, cultural, and chemical methods.',
        category: 'pest-control',
        duration: '6 weeks',
        level: 'Advanced',
        rating: 4.9,
        students: 890,
        thumbnail: 'https://images.unsplash.com/photo-1582979512210-99b6a53386f9?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
        lessons: 18,
        tags: ['pests', 'organic'],
        instructor: 'Prof. Robert Johnson',
        prerequisites: ['Introduction to Entomology'],
        outcomes: ['Identify common pests', 'Implement eco-friendly controls', 'Reduce pesticide use']
      },
      {
        id: '3',
        title: 'Smart Irrigation Systems',
        description: 'Master modern irrigation technologies that conserve water while optimizing crop growth.',
        category: 'irrigation',
        duration: '5 weeks',
        level: 'Intermediate',
        rating: 4.7,
        students: 1560,
        thumbnail: 'https://images.unsplash.com/photo-1597571261042-eb432b3f9b60?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
        lessons: 15,
        tags: ['water', 'technology'],
        instructor: 'Dr. Maria Garcia',
        prerequisites: ['Basic Hydraulics'],
        outcomes: ['Design efficient systems', 'Monitor water usage', 'Troubleshoot equipment']
      }
    ],
    resources: [
      {
        ...
        description: 'Complete guide to planting schedules for different crops throughout the year.',
        type: 'PDF',
        size: '2.4 MB',
        downloadUrl: '#',
        downloads: 3420
      },
      {
        ...
        description: 'Visual guide showing optimal fertilizer amounts for various crops and soil types.',
        type: 'Infographic',
        size: '1.8 MB',
        downloadUrl: '#',
        downloads: 2890
      },
      {
        ...
        description: 'Spreadsheet template for tracking and analyzing local weather patterns.',
        type: 'Excel Template',
        size: '0.9 MB',
        downloadUrl: '#',
        downloads: 1750
    ...
    learningPath: 'Based on your interest in soil health and crop management, we recommend starting with Sustainable Soil Management, followed by Integrated Pest Management, and concluding with Smart Irrigation Systems.',
    topicSuggestions: ['Cover Crops', 'Composting', 'Soil Testing', 'Beneficial Insects'],
    resourceLinks: [
      {
        title: 'FAO Sustainable Agriculture Guidelines',
        url: 'https://www.fao.org/sustainable-agriculture/en/',
        description: 'Official guidelines from the Food and Agriculture Organization'
      },
      {
        title: 'Local Extension Office Resources',
        url: 'https://www.usda.gov/topics/rural/extension',
        description: 'Access to local agricultural extension programs'
      }
    ],
    totalCount: 3,
    userStats: {
      ...
      {showHelp && (
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
          <h3 className="font-semibold text-blue-800 mb-2 flex items-center">
            ...
            How to Use the Education Center
          </h3>
          <ul className="list-disc pl-5 space-y-1 text-blue-700 text-sm">
            <li>Browse courses by category using the filter dropdown</li>
            <li>Select your interests to receive personalized recommendations</li>
            <li>Search for specific topics using the search bar</li>
            <li>Download resources to use offline in your farming operations</li>
            <li>Track your learning progress in the "Your Learning Journey" section</li>
            <li>Start with recommended courses based on your profile and interests</li>
          </ul>
          <p className="mt-2 text-blue-700 text-sm">
            All courses are designed by agricultural experts and updated regularly with the latest research.
          </p>
        </div>
      )}
