...
const PayPalPayment: React.FC<PayPalPaymentProps> = ({ planId }) => {
  ...
  const handleTestPayment = async () => {
    ...
    // Simulate PayPal redirect and approval
    await new Promise(resolve => setTimeout(resolve, 1500));
    
    toast.success('Test Mode: Redirecting to PayPal...');
    
    await new Promise(resolve => setTimeout(resolve, 1000));
    
    toast.success('Test Mode: PayPal approval received');
    
    await new Promise(resolve => setTimeout(resolve, 1000));
    
    toast.success('Test Mode: PayPal subscription created!');
