...
const PaymentPage: React.FC = () => {
  ...
  const checkDemoStatus = async () => {
    try {
      ...
      console.error('Check demo status error:', error);
    }
  };
    ...
    return (
      <PageTransition>
        <div className="min-h-screen flex items-center justify-center p-4">
          <AnimatedCard animation="scale" className="max-w-md w-full text-center p-8">
            <div className="mb-4">
        ...
        <div className="max-w-6xl mx-auto py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-1">
              <AnimatedCard animation="slide" delay={50} className="sticky top-4">
                <div className="p-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {/* Payment Form */}
              <AnimatedCard animation="scale" delay={150}>
                <div className="p-6">
              ...
              {/* Trust Badges */}
              <AnimatedCard animation="fade" delay={200} className="bg-gray-50">
                <div className="p-6">
